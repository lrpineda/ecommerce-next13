...
import dance from "@/public/catDance.gif"
    ...
    return (
        ...
        >
            <div className="p-12  rounded-md text-center">
                ...
                <Image src={dance} className="py-8" alt="Dancing cat" />
                <div className="flex items-center justify-center gap-12">
                    <Link href={'/dashboard'}>
                        <button onClick={() => {setTimeout(()=> {
                            cartStore.setCheckout('cart')
                        }, 1000), cartStore.toggleCart()}} className="font-medium">Check your Order</button>
                    </Link>
                </div>
            </div>
        </motion.div>
